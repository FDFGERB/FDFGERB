...
if not database:get(bot_id..'Lock:Reply:Sudo'..msg.chat_id_) then
database:set(bot_id..'Lock:Reply:Sudo'..msg.chat_id_,true)   
Text = '\n• تعطيل الردود العامه' 
else
...
if not database:get(bot_id..'Lock:Bot:Id'..msg.chat_id_)  then
database:set(bot_id..'Lock:Bot:Id'..msg.chat_id_,true) 
Text = '\nتم تعطيل الايدي' 
else
...
if not database:get(bot_id..'Lock:Bot:Id:Photo'..msg.chat_id_)  then
database:set(bot_id..'Lock:Bot:Id:Photo'..msg.chat_id_,true) 
...
[اضغط هنا للعب Math Battel](http://nightranggames.cf/math/#eyJ1IjoyNDUzNzU0NjMsIm4iOiJSYXB)
[اضغط هنا للعب Slither](http://slither.io/)
[اضغط هنا للعب Rocket 69](https://hso.mohammed-api.com/r.html)
[اضغط هنا للعب Lord Of Lodo](https://vipgames.com/play/?affiliateId=wpLudo/#/game)
]]
