...
if text == 'السيرفررر' and SudoBot(msg) then 
...
if text == 'السيرفرر' and SudoBot(msg) then 
...
list = {"قتنىلثخةبثبةثبةثحةبةحثحةبحسثبةحثةبحثةبحةبحثةبثةحب"}
for k,v in pairs(list) do
print(string.find(text,v))
if string.find(text,v) ~= nil then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
...
local list = database:smembers(bot_id.."FDFGERB1s\x:List:Filter"..msg.chat_id_)  
t = "\n⌔︙قائمة المنع \n ••━━━━━•• \n"
for k,v in pairs(list) do  
