...
print('\n\27[1;31m￤ This is Not USERID \n￤هہ‏‏ذا الايدي ليس موجود بل تلكرام , عذرا ادخل الايدي الصحيح الان . ')
end 
os.execute('lua FDFGERB.lua')
end
...
var = database:get(bot_id.."Mote:Rd"..msg.chat_id_) or 'قلبي' 
else
...
local url = "https://api.telegram.org/bot"..token..'/deletemessage?chat_id='..chat_id..'&message_id='..message_id
return s_api(url)
end
...
function sendVoicee(chat_id,reply_id,voice,caption,func)
tdcli_function({
ID="SendMessage",
chat_id_ = chat_id,
...
function sendVideoo(chat_id,reply_id,video,caption,func)
pcall(tdcli_function({ 
ID="SendMessage",
chat_id_ = chat_id,
reply_to_message_id_ = reply_id,
...
if database:get(bot_id.."Bc:channel:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء •' then   
send(msg.chat_id_, msg.id_," تم الغاء الاذاعه") 
database:del(bot_id.."Bc:channel:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id..'new:channel') 
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,'['..msg.content_.text_..']')  
end
...
send(msg.chat_id_, msg.id_,"• تمت الاذاعه الى ⇠{"..#list.."} قناة في البوت ")     
database:del(bot_id.."Bc:channel:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
------------------------------------------------------------------------
...
local channelbots = database:scard(bot_id..'new:channel')  
Text = '• عدد المجموعات ⇠  {'..Groups..'}'..'\n • عدد المشتركين ⇠  {'..Users..'}'..'\n • عدد القنوات ⇠  {'..channelbots..'}'
send(msg.chat_id_, msg.id_,Text) 
return false
end
...
if text=="اذاعه خاص بالتوجيه" and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
...
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," عزيزي المستخدم هذا معرف قناة يرجى استخدام الامر بصوره صحيحه ")   
return false 
end      
...
if text and database:get(bot_id..'lock:emoje'..msg.chat_id_) and not Manager(msg) then 
list = {"😀","😃","😄","😁","😆","😅","😂 ","🤣","☺️","😊","😇","🙂","🙃","😉","😌","😍","🥰","😘","😗","😙","😚","😋","😛","😝","😜","😜","🤪","🤨","🧐","🤓","😎","🤩","🥳","😏","😒","😞","😔","😟","😕","🙁","☹️","😣","😖","😫","🥺","😢","😭","😤","😠","😡","🤬","🤯","😳","🥵","🥶","😱","😨","😰","😥","😓","🤗","🤔","🤭","🤫","🤥","😶","😐","😑","😬","🙄","😯","😦","😧","😮","😲","🥱","😴","🤤","😪","🤤","😵","🤠","🤑","🤕","🤒","😷","🤮","😷","🤢","🥴"}
for k,v in pairs(list) do
print(string.find(text,v))
if string.find(text,v) ~= nil then
...
send(msg.chat_id_,msg.id_,' هذا الامر خاص Commander فقط')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
elseif text == 'قفل الايموجي' and msg.reply_to_message_id_ == 0 then
if not Manager(msg) then
send(msg.chat_id_,msg.id_,'اهلا عزيزي \n عذرا الامر يخص ⇠ مدير - منشئ')
return false
end 
...
elseif text == 'فتح الايموجي' and msg.reply_to_message_id_ == 0 then
if not Manager(msg) then
send(msg.chat_id_,msg.id_,'اهلا عزيزي \n عذرا الامر يخص ⇠ مدير - منشئ')
return false
end 
database:del(bot_id..'lock:emoje'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• بواسطه ⇠ ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'hlIl3')..') \n تم فتح السب\n')  
end,nil)   
...
if not Sudo(msg) then
send(msg.chat_id_,msg.id_,' هذا الامر خاص Commanderفقط')
return false
end
...
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:taha:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n〽┇ارسل لي الكلمه الان ')
database:set(bot_id.."botss:taha:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:taha:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:taha:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:taha:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"☑┇تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:taha:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:taha:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:taha:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:taha:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:taha:List:Rd:Sudo", text)
return false
end
end
if text == ("مسح الردود المتعدده") and SudoBot(msg) then 
local list = database:smembers(bot_id.."botss:taha:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:taha:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:taha:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:taha:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:taha:List:Rd:Sudo")
end
...
if text == "اضف رد متعدد عام" and SudoBot(msg) then 
database:set(bot_id.."botss:taha:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"📮┇ارسل الان الكلمه لاضافتها ")
end
if text == "حذف رد متعدد عام" and SudoBot(msg) then 
database:set(bot_id.."botss:taha:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"📮┇ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:taha:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:taha:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:taha:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:taha:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:taha:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:taha:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:taha:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:taha:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:taha:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:taha:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:taha:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:taha:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"📌┇تم حفظ الرد الثالث ")
return false  
end  
end
if text then
local Text = database:get(bot_id.."botss:taha:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:taha:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:taha:Add:Rd:Sudo:Text2"..text)   
...
if text and text:match('@all (.*)') and Manager(msg) then
...
username = ('t.me/'..data.username_ or 'tg://user?id='..taha.members_[i].user_id_)
t = t..' ['..data.first_name_..']('..username..') \n '
if #list == i then
...
send1(msg.chat_id_, msg.id_,linkgp)              
end            
 end,nil)
end
...
tt = '\nاهلابك عزيزي '..Rutba(msg.sender_user_id_,msg.chat_id_)..' \n لوضع الاسم  - name \n لوضع معرف - user \n لوضع اسم قروب titel '
...
if text == 'المطور' or text == 'Commander' or text == 'المٌطور' then
...
send(msg.chat_id_, msg.id_,"قوانين القروب \n 1 - يمنع السب و الشتم \n 2 - يمنع اللتدخل في الامور السياسيه \n 3 - يمنع تكلم في الامور الدينيه \n 4 - يمنع تعدي على مشرفين القروب \n 5 - احترم تحترم")   
end    
end
...
send(msg.chat_id_, msg.id_, "•  نوع رتبه \n• {عضو -- مميز -- ادمن -- مدير}") 
end
...
if num > 500 then 
send(msg.chat_id_, msg.id_,' تستطيع المسح(500) رساله كحد اقصى ')
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
if text=="اذاعه للقنوات" and msg.reply_to_message_id_ == 0 then 
if not Sudo(msg) then
send(msg.chat_id_,msg.id_,' هذا الامر خاص Commander فقط')
return false
end 
database:setex(bot_id.."Bc:channel:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\nللخروج ارسل الغاء ") 
return false
end  
...
if text=="اذاعه خاص بالتوجيه" and msg.reply_to_message_id_ == 0  then
if not Sudo(msg) then
send(msg.chat_id_,msg.id_,' هذا الامر خاص Commanderفقط')
return false
end 
...
if text == 'اوامر التعطيل' and Manager(msg) then
local Texti = 'اهلا عزيزي '..Rutba(msg.sender_user_id_,msg.chat_id_)..' \n يمكنك تحكم في اوامر التعطيل من هنا '
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == 'اوامر القفل' and Mod(msg) then
local Texti = 'اهلا عزيزي '..Rutba(msg.sender_user_id_,msg.chat_id_)..' \n يمكنك تحكم في اوامر القفل من هنا '
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if Text == '/lockdul' and Manager(data) then
...
elseif Text == '/lock_links' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/lockmyphoto' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/lockwelcome' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/lockrepall' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/lockide' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/lockidephoto' and Manager(data) then
local Textedit = '• تم تعطيل الايدي بالصوره '
database:set(bot_id..'Bot:Id:Photo'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمه الرئيسيه', callback_data="/homeaddrem"},
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/lockkiked' and Manager(data) then
local Textedit = '• تم تعطيل الحظر '
database:set(bot_id..'Lock:kick'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمه الرئيسيه', callback_data="/homeaddrem"},
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/locksetm' and Manager(data) then
local Textedit = '• تم تعطيل الرفع '
database:set(bot_id..'Lock:Add:Bot'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمه الرئيسيه', callback_data="/homeaddrem"},
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/lockaddme' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/locksehe' and Manager(data) then
local Textedit = '• تم تعطيل صيح '
database:set(bot_id..'Seh:User'..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمه الرئيسيه', callback_data="/homeaddrem"},
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/lockkikedme' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/lockgames' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/lockrepgr' and Manager(data) then
...
if Text == '/unlockdul' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/unlock_links' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/unlockmyphoto' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/unlockwelcome' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/unlockrepall' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/unlockide' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/unlockidephoto' and Manager(data) then
local Textedit = '• تم تفعيل الايدي بالصوره '
database:del(bot_id..'Bot:Id:Photo'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمه الرئيسيه', callback_data="/homeaddrem"},
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/unlockkiked' and Manager(data) then
local Textedit = '• تم تفعيل الحظر '
database:del(bot_id..'Lock:kick'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمه الرئيسيه', callback_data="/homeaddrem"},
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/unlocksetm' and Manager(data) then
local Textedit = '• تم تفعيل الرفع '
database:del(bot_id..'Lock:Add:Bot'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمه الرئيسيه', callback_data="/homeaddrem"},
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/unlockaddme' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/unlocksehe' and Manager(data) then
local Textedit = '• تم تفعيل صيح '
database:del(bot_id..'Seh:User'..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمه الرئيسيه', callback_data="/homeaddrem"},
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/unlockkikedme' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/unlockgames' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/unlockrepgr' and Manager(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/homeaddrem' and Manager(data) then
local Texti = 'اهلا عزيزي '..Rutba(msg.sender_user_id_,msg.chat_id_)..' \n يمكنك تحكم في اوامر التعطيل من هنا '
keyboard = {} 
keyboard.inline_keyboard = {
{
...
database:set(bot_id.."lock:inline"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمه الرئيسيه', callback_data="/homelocks"},
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/unlockinlene' and Mod(data) then
local Textedit = '• تم فتح الانلاين '
database:del(bot_id.."lock:inline"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمه الرئيسيه', callback_data="/homelocks"},
